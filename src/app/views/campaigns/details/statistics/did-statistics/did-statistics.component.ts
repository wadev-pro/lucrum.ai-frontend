...
@Component({
  selector: 'app-campaign-details-statistics-did-statistics',
  templateUrl: './did-statistics.component.html',
  styleUrls: ['./did-statistics.style.css'],
  animations: egretAnimations,
})
export class DidStatisticsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.filter$ = this.store$.select(didFilterSelector);
    this.meta$ = this.store$.select(didMetaSelector);
  ...
  loadData() {
    ...
    this.store$.dispatch(new CampaignStatisticsActions.GetDid(payload));
  }
  ...
  updateFilter(data) {
    ...
    this.store$.dispatch(
      new CampaignStatisticsActions.UpdateDidFilter(updated_filter)
    );
  }
