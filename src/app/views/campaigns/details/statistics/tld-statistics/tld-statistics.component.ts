...
@Component({
  selector: 'app-campaign-details-statistics-tld-statistics',
  templateUrl: './tld-statistics.component.html',
  styleUrls: ['./tld-statistics.style.css'],
  animations: egretAnimations,
})
export class TldStatisticsComponent implements OnInit, OnDestroy {
  ...
  loadData() {
    ...
    this.store$.dispatch(new CampaignStatisticsActions.GetTld(payload));
  }
  ...
  updateFilter(data) {
    ...
    this.store$.dispatch(
      new CampaignStatisticsActions.UpdateTldFilter(updated_filter)
    );
  }
